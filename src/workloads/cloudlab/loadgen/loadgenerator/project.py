...
class Page(TaskSet):
    ...
    print("==============IN PAGE===================")
    tasks = { move_and_write: 100, spell_check: 100, download_project: 20, compile: 10, chat: 0, show_history: 70, get_image: 0,  share_project: 2, tag: 1, stop: 1, file_upload: 10}
    if len(PAGE_TASKS):
