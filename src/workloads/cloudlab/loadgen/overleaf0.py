...
from src.workloads.cloudlab.loadgen.loadgenerator import project0, csrf, randomwords
# import metrics
import logparser
import socket
import datetime
...
# # SHARE_PROJECT_TIMEOUT = 100
# WEBSOCKET_TIMEOUT = 0.3
...
def save_raw_stats(filename):
    print("#success: %s, fail: %s, error: %s #" % (nr_success, nr_failed, nr_error))
    print("#pos triggered: %s, pos_registered: %s #" % (project0.pos_triggered, project0.pos_registered))
