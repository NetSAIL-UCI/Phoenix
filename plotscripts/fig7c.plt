...
set output "../outputs/Fig6c.pdf"
set ylabel "Normalized Capacity Utilized" font ",9" 
set xlabel "Cluster Capacity Failed (%)" font ",10" #offset 2

set key inside bottom left font ",9" # top outside
...
plot "../processedData/Mix1UniformLongTail10000_util.txt" u (($1*100)):2 title "Phoenix" with linespoints lc rgb "red" lw 2 lt 2 pointtype 2, \
'' u (($1*100)):3 title "Priority" with linespoints lc rgb "#0000FF" lw 2 lt 3 dashtype "_" pointtype 10, \
 '' u (($1*100)):4 title "Fair" with linespoints lc rgb "#088F8F" lw 2 dashtype "--" pointtype 11, \
  '' u (($1*100)):5 title "LP" with linespoints lc rgb "#6495ED" lw 2  dashtype ".." pointtype 6, \
# unset border; set xtics format " "; set ytics format " "; set ylabel " "
# call 'hist_r.gnu'
# unset multiplot#E97451